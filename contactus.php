		...
		<div class='row'>
			...
			<div class='content'>
				...
				<div id='navigation'>
						...
						<ul>
							<li style='background-color:blue;'><a href="contactus.php">Contact Us</a></li>
						</ul>
					</div><!--end navigation-->
				...
				<!--gallery-->
					<div class='container' style='margin-top:100px'>
						<div class='row' id='gallery'>
							<div class='span6 columns contactus'>
								<img src="assets/img/image5.jpg">

							<br><br>
								<p>We encourage you to contact us whenever you have a question or concern.</p>

								<table>
									<tr>
										<td style='color:green'>Tel.:</td>
										<td>(+63)942200287</td>
									</tr>
									<tr>
										<td></td>
